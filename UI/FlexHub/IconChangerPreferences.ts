...
export default class IconChangerPreferences extends BaseHubWindow {
    constructor() {
        super(
            ...
            new HStack(
                new IconButton('reload', 'alternative', new IonIcon('refresh')),
                new IconButton(
                    'reload',
            ...
            new HStack(
                new IconButton('hub', 'home-filled', new IonIcon('home')),
                new IconButton('hub', 'apps-filled', new IonIcon('apps')),
                new IconButton('hub', 'grid-filled', new IonIcon('grid')),
                new IconButton('hub', 'rocket-filled', new IonIcon('rocket')),
            )
                .width('100%')
                .alignStart(),
